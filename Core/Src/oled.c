...
{
    OLED_Clear();
    // OLED_ShowString(127, 0, (uint8_t *)".");
    OLED_ShowCHinese(0, 0, 10);  //
    OLED_ShowCHinese(18, 0, 11); //
    OLED_DecimalShow(32, 0, temp, 3, 2, 16);

    OLED_ShowCHinese(0, 2, 8);  //
    OLED_ShowCHinese(18, 2, 9); //
     OLED_DecimalShow(32, 2, humi, 3, 2, 16);

    OLED_ShowCHinese(10, 4, 0);  //
    OLED_ShowCHinese(28, 4, 1);  //
    OLED_ShowCHinese(46, 4, 2);  //
    OLED_ShowCHinese(64, 4, 3);  //
    OLED_ShowCHinese(82, 4, 4);  //
    OLED_ShowCHinese(100, 4, 5); //

    OLED_ShowString(24, 6, (uint8_t *)"2020-2-5");
}
